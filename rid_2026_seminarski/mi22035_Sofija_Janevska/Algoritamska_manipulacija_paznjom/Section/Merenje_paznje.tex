...
\subsection{Ključne metrike engagementa}
...
Posebno važna metrika je i retention, odnosno zadržavanje korisnika kroz vreme. Za platformu nije dovoljno da korisnik jednom klikne ili jednom pogleda sadržaj. Mnogo je važnije da se vraća: kasnije istog dana, sutradan, naredne nedelje i iznova nakon svake pauze. Retention zato pokazuje da li platforma uspeva da postane deo korisnikove rutine. U tom smislu, cilj više nije samo trenutna reakcija, već stvaranje navike \cite{wu2017returning}.
