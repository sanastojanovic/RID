...
{Jana Milutinović -- \emph{Pregled razvoja računarstva u 21. veku} (2023)}
...
\textbf{Primer seminarskog rada iz repozitorijuma:}\\
\href{https://github.com/sanastojanovic/RID/blob/main/rid_2022_seminarski/mi18241_Bo\%C5\%BEi\%C4\%87_Marija/2_predavanje/seminarski_rad.pdf}%
{Marija Božić -- \emph{Moralna i etička dilema autonomnih vozila} (2022)}
...
\textbf{Primer seminarskog rada iz repozitorijuma:}\\
\href{https://github.com/sanastojanovic/RID/blob/main/rid_2026_seminarski/mi22091_Viktor_\%C5\%A0evi\%C4\%87/seminarski_1.pdf}%
{Viktor Šević -- \emph{Korporatizacija interneta} (2026)}
...
{Prezentacija ,,Cenzura, sloboda govora i neprikladan sadržaj`` (Marko Bura, RID 2022)}

\textbf{Primer seminarskog rada iz repozitorijuma:}\\
\href{https://github.com/sanastojanovic/RID/blob/main/rid_2022_seminarski/mi18130_Bogdan_Markovic/predavanje_2/BogdanMarkovicSeminarski.pdf}%
{Bogdan Marković -- \emph{Filterski mehur} (2022)}
...
\textbf{Primer seminarskog rada iz repozitorijuma:}\\
\href{https://github.com/sanastojanovic/RID/blob/main/rid_2022_seminarski/mi17091_Miletic_Luka/predavanje_2/Zavisnost_pametnih_telefona_i_njihov_uticaj.pdf}%
{Luka Miletić -- \emph{Zavisnost od pametnih telefona i njihov uticaj} (2022)}
...
{Prezentacija o sajber bezbednosti ,,cybersec.pdf`` (Andrija Urošević, RID 2022)}\\
...
{Katarina Grbović -- \emph{Ofanzivna bezbednost i pentesting} (2025)}
...
{Marko Lazarević -- \emph{Privacy in the AI Era} (2025)}
...
\textbf{Primer seminarskog rada iz repozitorijuma:}\\
\href{https://github.com/sanastojanovic/RID/blob/main/rid_2025_seminarski/mi21207_Matija_Stankovic/seminarski/ChatGPT_i_njegov_uticaj_na_op\%C5\%A1te_znanje.pdf}%
{Matija Stanković -- \emph{ChatGPT i njegov uticaj na opšte znanje} (2025)}
