...
\subsection{Šta je veštačka inteligencija?}
    Teško je definisati šta je veštačka inteligencija sama po sebi. Alan Turing je u svojoj skripti "Computing machinery and intelligence" rekao da se mašina može proglasiti pametnom ukoliko je nemoguće razaznati razliku između nje i čoveka u toku razgovora sa nekim slucajno izabranim posmatračem. \cite{turing2007computing} U današnje vreme bismo mogli reći da je mašina pametna ukoliko može da govori, razmišlja i postupa na sličan način kao što bi čovek uradio.
