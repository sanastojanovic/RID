...
\chead{\textbf{}}
\lfoot{dr Sana Stojanović Đurđević}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.18\textwidth]{Bloch_sphere.svg}
...
\begin{thebibliography}{9}
    ...
    \bibitem{G7} TIMELINE OF QUANTUM COMPUTERS AND THE HISTORY OF QUANTUM COMPUTING \href{http://quantumly.com/timeline-of-quantum-computing-history-of-quantum-computers-dates.html}{quantumly.com}

    \bibitem{G8} Google officially lays claim to quantum supremacy (2019), Emily Conover \href{https://www.sciencenews.org/article/google-quantum-computer-supremacy-claim}{sciencenews.org}
\end{thebibliography}
}
\end{document}