...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Prilagođavanje odgovora u toku razgovora
    \end{itemize}
    \item Ključna prednost: \textbf{visoka dostupnost i jednostavnost korišćenja}
    \item \textbf{Tehnološka ograničenja modela:}
    \begin{itemize}
        \item Generisanje statistički verovatnih odgovora
        \item Mogućnost halucinacija
        \item Nedostatak stvarnog razumevanja 
\end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Brz i jednostavan pristup informacijama
...
\begin{itemize}
    ...
    \item ChatGPT nije autoritativni izvor znanja: \textbf{neophodna je dodatna provera informacija}
...
\begin{itemize}
    ...
    \end{itemize}
    \item Opšte znanje postaje:
    \begin{itemize}
        \item \textbf{veština snalaženja u informacijama}
    \end{itemize}
\end{itemize}
\end{frame}
