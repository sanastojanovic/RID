...
hardver, softver i sistemi za prenos informacija. Pretečama današnjih računara smatraju se elektronske računske mašine, koje su omogućile automatsku obradu
...
Početak druge faze razvoja vezuje se za uvođenje tranzistora, koji su zamenili vakuumske cevi.
...
\begin{itemize}
    ...
    \end{itemize}
    \item Galaksija - prvi Jugoslovenski računar
    \begin{itemize}
        \item \url{https://www.dejanristanovic.com/galaks.htm}
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item {\href{https://www.acas.rs/storage/page_files/Etika%20i%20integritet%20u%20javnom%20sektoru%20priru%C4%8Dnik%20za%20izvo%C4%91enje%20obuke%20(2015)_1.pdf}{https://www.acas.rs}}
        \item \url{https://www.youtube.com/playlist?list=PLHBowDEf-zianeStj6g72KC8KGT85jKar}
    \end{itemize}
    \item Algoritamska pristrasnost i diskriminacija
    \begin{itemize}
        \item {\href{http://ricl.iup.rs/1693/1/2023%20-%20Uporednopravni%20izazovi%20u%20savremenom%20pravu%20-%20In%20memoriam%20Stefan%20Andonovi%C4%87%20-%20Prlja%20et%20al.pdf}{http://ricl.iup.rs}}
    \end{itemize}
...
Internet i World Wide Web ne predstavljaju isto. Internet je globalna računarska mreža, a World Wide Web jedan od servisa koji funkcioniše na internetu i koristi njegovu
...
deca često izložena pornografskom, nasilnom ili uznemirujućem sadržaju. 
Ovaj problem postaje znatno ozbiljniji sa porastom popularnosti pametnih telefona i stalnim pristupom mreži.

\textbf{Prečišćivač Veba} je alat koji filtrira i onemogućava prikaz nepoželjnih
...
\begin{itemize}
    ...
    \begin{itemize}
        \item {\href{https://insajder.net/vesti/sloboda-govora-u-digitalnom-prostoru-ko-stoji-iza-gasenja-instagram-naloga-medija-i-nvo}{https://insajder.net}}
    \end{itemize}
...
\begin{itemize}
    \item \textbf{Elektronska pošta} - lažne elektronske poruke u kojima napadač zahteva unos ličnih podataka korisnika,
...
su namerno plasirane sa ciljem manipulacije korisnicima. Ovo može biti dosta opasno, jer su informacije na internetu lako dostupne svima, i iako internet može biti sjajno mesto za informisanje moramo naučiti da kritički rasuđujemo o informacijama koje pokupimo sa interneta.
...
Neki od pokazatelja zavisnosti od interneta su:
\begin{itemize}
...
Firesheep je ekstenzija pomoću koje svaki korisnik može da preuzme kolačiće neenkriptovane veb strane.
...
korisnika radi pamćenja podešavanja (na primer ime, prezime, adresa, poštanski broj itd.) pri onlajn kupovini.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        u svrhu dobijanja informacija o tome kada korisnik poseti sajt na kome oni imaju svoje kolačiće.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item korišćenjem režima privatnog pregleda (engl. \textit{incognito}).
\end{itemize}
