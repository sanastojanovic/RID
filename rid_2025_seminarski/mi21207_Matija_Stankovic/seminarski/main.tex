...
\begin{itemize}
    ...
    znanja korisnika.
    \item \textbf{Podrška samostalnom učenju} - omogućava korisnicima da istražuju nove teme sopstvenim tempom i da dobiju dodatna objašnjenja van formalnog obrazovnog okruženja.
\end{itemize}
