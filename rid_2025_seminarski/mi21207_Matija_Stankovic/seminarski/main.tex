...
\begin{itemize}
    ...
    znanja korisnika.
    \item \textbf{Podrška samostalnom učenju} - omogućava korisnicima da istražuju nove teme sopstvenim tempom i da dobijaju dodatna objašnjenja van formalnog obrazovnog okruženja.
\end{itemize}

Istovremeno, postoje i ozbiljni rizici:
\begin{itemize}
    \item \textbf{Smanjenje kritičkog razmišljanja} - rizik da korisnici prihvataju odgovore bez dodatne analize i provere.
    \item \textbf{Bezbednosni i privatnosni rizici} - mogućnost nenamernog deljenja ličnih podataka, poverljivih informacija o firmama ili izvornog koda koji nije namenjen javnoj upotrebi.
    \item \textbf{Iluzija razumevanja} - korisnici mogu steći utisak da razumeju određenu temu samo zato što su dobili jasan i tečan odgovor, iako nisu razvili dublje razumevanje pojmova i njihovih međusobnih povezanosti.

\end{itemize}
Istraživanja ukazuju da prekomerno oslanjanje na automatizovane sisteme za dobijanje informacija može dovesti do površnog razumevanja gradiva i smanjenja sposobnosti kritičkog razmišljanja~\cite{bommasani2021}. Zbog toga je važno razvijati svest o ograničenjima ovakvih sistema i podsticati njihovu odgovornu i promišljenu upotrebu.
