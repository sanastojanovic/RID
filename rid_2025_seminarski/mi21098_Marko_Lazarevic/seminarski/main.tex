...
Veštačka inteligencija (eng. \textit{Artificial intelligence} - \textbf{AI}) je nešto sa čim se sve češće susrećemo – postala je deo savremenog života i mnogima predstavlja sastavni deo svakodnevice. Evolucija veštačke inteligencije i mašinskog učenja (eng. \textit{Machine learning} - \textbf{ML}) predvodila je digitalnu transformaciju u poslednjoj deceniji. AI i ML su postigli značajne proboje, počevši od \textit{nadgledanog učenja}, a zatim su se brzo razvijali kroz \textit{nenadgledano}, \textit{polunadgledano}, \textit{učenje potkrepljivanjem} i \textit{duboko učenje}. Najnovija granica AI tehnologije stigla je u obliku \textit{generativne veštačke inteligencije} \cite{10198233}. Kroz nadgledano i polunadgledano učenje postignuta su značajna ubrzanja u poslovnim procesima, dok su nenadgledano učenje i učenje potkrepljivanjem doprineli većem stepenu automatizacije u određenim oblastima rada. Generativna veštačka inteligencija predstavlja jedan od najznačajnijih iskoraka u oblasti veštačke inteligencije. Alati generativne veštačke inteligencije omogućavaju generisanje različitih oblika sadržaja, kao što su tekst, slike, zvuk, animacije, izvorni kod i drugi formati podataka. Pokretanje sistema \textit{ChatGPT} (engl. \textit{Generative Pre-trained Transformer}), moćnog alata generativne veštačke inteligencije koji je razvila kompanija \textit{OpenAI} u novembru 2022. godine, izazvalo je značajan preokret u čitavoj zajednici veštačke inteligencije i mašinskog učenja \cite{10198233}. Od tada, sve veći broj korisnika koristi alate zasnovane na veštačkoj inteligenciji, što je dovelo do brojnih promena u poslovnom okruženju i razvoja sve većeg broja različitih AI alata.
...
Iako veštačka inteligencija donosi brojne koristi, postoje mnoga \textbf{pravna} i \textbf{etička pitanja} koja se mogu postaviti kada se govori o njenoj upotrebi. Na primer, u situaciji da razgovaramo sa čet-botom (\textit{ChatGPT}) i podelimo s njim strategije i planove za budućnost svoje kompanije, postavlja se pitanje da li do tih informacija može doći konkurentska firma. Da li se podaci koje unosimo u AI alate za obradu teksta (npr. prevodioci, asistenti za pisanje) koriste za dalje treniranje modela, i ako da — da li su ti podaci anonimizovani? Kada koristimo AI alate za sumiranje sadržaja ili automatsko odgovaranje na e-poruke, ko sve može imati uvid u naše privatne i poverljive podatke? Takođe, kada svoju fotografiju obradimo pomoću AI alata za ulepšavanje, nameće se sumnja da li ta slika može završiti u rukama osobe koja bi pokušala da nam ukrade identitet. Ukoliko koristimo alate veštačke inteligencije za prepoznavanje pokreta putem video-nadzora, da li snimci sa naših kamera mogu postati dostupni trećim stranama? Kako možemo znati da li je AI alat u koji unosimo podatke u skladu sa važećim propisima i regulativama o zaštiti podataka? Da li se naši lični podaci čuvaju nakon interakcije sa AI alatima, i ako se čuvaju – koliko dugo i gde? U kolikoj meri korisnik ima kontrolu nad podacima koje AI sistem prikuplja i analizira? Na koji način korisnik može proveriti da li su njegovi podaci uključeni u obučavanje nekog modela?

Sva ova, ali i mnoga druga pitanja, mogu se postaviti kada govorimo o veštačkoj inteligenciji. S obzirom na to da se AI sve više koristi  u svakodnevnim situacijama, a sve češće dajemo i potpunu slobodu odlučivanja isključivo veštačkoj inteligenciji, dolazimo do verovatno najvažnijeg pitanja vezanog za privatnost. To pitanje glasi: kako se pravno regulišu razvoj, upotreba i odgovornost u vezi sa veštačkom inteligencijom – ko snosi odgovornost ukoliko AI donese pogrešnu odluku i na koji način se štite prava korisnika? O svim aspektima ovog pitanja biće više reči u narednim poglavljima.
...
Uzmimo, na primer, AI sistem koji razvrstava naučne tekstove prema oblasti. On se obučava "`čitanjem"' nekoliko hiljada naučnih tekstova. Koristeći te podatke, sistem prepoznaje obrasce koji određene tekstove grupišu u određene grupe. Pored toga, on pravi pretpostavke o tome koje su to bitne reči koje jedan tekst odvajaju od drugog. U ranim fazama obuke sistem često pogrešno procenjuje značaj određenih reči. Što su podaci bolji, to će se više netačnih pretpostavki o bitnim rečima ispraviti ili odbaciti \cite{whitevision_ai_privacy}. Na primer, engleska reč "`The"' će sigurno biti prepoznata kao nebitna, dok će se, na primer, reč "`\textit{mikrokontroler}"' sigurno češće pojaviti u tekstovima vezanim za robotiku nego u tekstovima vezanim za medicinu.

Za preciznost i robusnost AI alata potrebne su ogromne količine podataka kako bi što bolje mogao da prepoznaje obrasce i postavi pretpostavke. Pored naučnih tekstova, u praksi se AI sistemi često treniraju i na podacima koji uključuju lične informacije, što otvara nova etička i pravna pitanja. Odakle tolike količine podataka dolaze? Ukoliko se radi o ličnim podacima, da li imamo pravo da ih koristimo za treniranje naših alata?


\subsection{Uticaj veštačke inteligencije na privatnost}

Privatnost u eri veštačke inteligencije postala je jedno od najvažnijih pitanja u modernom društvu. Veštačka inteligencija (AI) se često povezuje sa problemima u vezi sa prikupljanjem podataka, sajber bezbednošću, dizajnom modela i upravljanjem podacima. Neki od ključnih rizika vezanih za privatnost uključuju:

\begin{itemize}
    \item \textbf{Prikupljanje osetljivih podataka}.  
    Veštačka inteligencija donosi veće rizike po privatnost podataka nego prethodna tehnološka dostignuća zbog ogromnog obima podataka koji se koriste. Terabajti ili petabajti podataka, kao što su tekst, slike ili video zapisi, rutinski se koriste kao podaci za obuku. Ovi podaci često uključuju osetljive informacije, kao što su zdravstveni podaci, lični podaci sa društvenih mreža, finansijski podaci, biometrijski podaci koji se koriste za prepoznavanje lica i drugi \cite{ibm_ai_privacy}.  

    \item \textbf{Prikupljanje podataka bez pristanka}.  
    Rizici privatnosti nastaju kada se podaci za razvoj AI tehnologija prikupljaju bez izričitog pristanka ili znanja ljudi od kojih se podaci prikupljaju. Na primer, korisnici internet platformi sve više očekuju veću kontrolu nad sopstvenim podacima i transparentnost u vezi sa njihovim korišćenjem, iako to često nije slučaj — dozvole za korišćenje ličnih podataka umeju da budu duboko skrivene u uslovima korišćenja koje korisnik prihvata prilikom otvaranja naloga na određenoj platformi. Takve situacije su postale predmet spora, kao što je nedavni slučaj sa LinkedIn platformom, gde su neki korisnici primetili da su dozvole za prikupljanje njihovih podataka za obuku generativnih AI modela automatski uključene \cite{ibm_ai_privacy}.

    \item \textbf{Korišćenje podataka bez dozvole}. 
    Čak i kada podaci budu prikupljeni uz saglasnost korisnika, rizici privatnosti ostaju ako se podaci koriste u svrhe koje nisu bile prvobitno obelodanjene. Na primer, fotografije ili biografski podaci koje smo ustupili radi specifične namene mogu se potencijalno koristiti za obuku AI sistema, često bez našeg znanja ili pristanka. U nekim slučajevima, korisnici su otkrili da su njihovi medicinski podaci korišćeni za obuku AI sistema, iako nisu dali saglasnost za takvu upotrebu \cite{ibm_ai_privacy}.  

    \item \textbf{Nekontrolisano nadgledanje i pristrasnost}. 
    Problemi sa privatnošću koji se odnose na široko rasprostranjeno i nekontrolisano nadgledanje, bilo putem sigurnosnih kamera na javnim mestima ili kolačića za praćenje na ličnim računarima, postojali su i pre širenja AI tehnologija. Međutim, AI može pogoršati ove probleme jer se AI modeli koriste za analizu podataka sa nadzora. U nekim slučajevima, rezultati takve analize mogu biti štetni, posebno kada odražavaju pristrasnost u podacima. Na primer, u oblasti sprovođenja zakona, brojna hapšenja ljudi su posledica AI odluka koje su donesene na osnovu pristrasnosti generisane od strane AI \cite{ibm_ai_privacy}.  

    \item \textbf{Ekstrakcija podataka}.
    AI modeli sadrže veliku količinu osetljivih podataka koji mogu postati plen za napadače. Napadi na AI aplikacije mogu uključivati tehnike poput prompt injekcije, gde maskirani ulazi manipulišu generativnim AI sistemima kako bi izložili osetljive podatke. Hakeri su nedavno demonstrirali tehniku u kojoj je fotografija konstruisana tako da, kada se obradi od strane Google Gemini bota, otkriva skriveni tekst. AI sistem zatim tumači taj tekst kao legitimni ulaz, što napadaču omogućava izvođenje neautorizovanih radnji, kao što je slanje sačuvanih podataka o bankovnoj kartici na određenu e-mail adresu \cite{Chandekar2025}.  

    \item \textbf{Curenje podataka}. 
    Curenje podataka podrazumeva nenamerno ili slučajno izlaganje osetljivih informacija od strane AI sistema. Neki AI modeli su se pokazali ranjivima na takve provale. Na primer, u jednom poznatom slučaju, ChatGPT je korisnicima pokazao naslove istorija razgovora drugih korisnika, što je dovelo do neželjenog deljenja privatnih podataka. Čak i mali proprijetarni AI modeli mogu izazvati curenje podataka ako, na primer, AI aplikacija nenamerno deli informacije sa drugim korisnicima na osnovu određenih upita \cite{ibm_ai_privacy}.  
\end{itemize}
...
Alati veštačke inteligencije zahtevaju velike količine podataka kako bi njihovi rezultati bili što precizniji i pouzdaniji. Često se može desiti da se prilikom treniranja modelu daju podaci koji \textit{nije trebalo da budu uključeni}. Takav pristup može nehotice izazvati ozbiljne probleme, uključujući netačne procene performansi tokom eksperimentalne faze razvoja AI modela, kao i otežanu mogućnost ponovnog dobijanja istih rezultata. \cite{apicella2024dontpushbuttonexploring}.  Sve ovo dovodi do toga da se kasnije smanjuje tačnost AI modela.

U ovom kontekstu, curenje podataka se često označava i kao \textit{curenje obrazaca} (eng. \textit{pattern leakage}) — situacija u kojoj se informacije koje bi trebalo da ostanu skrivene nehotice uvode u skup podataka koji se koristi za obučavanje sistema, čime se kompromituje objektivna procena performansi modela \cite{apicella2024dontpushbuttonexploring}. 
...
Pored pogrešne evaluacije, treniranje AI modela često zahteva značajne vremenske resurse zbog složenosti algoritama i obima korišćenih podataka. Ukoliko se greška u podacima ili u procesu treniranja ne uoči na vreme, cela faza obuke mora biti ponovljena, što uključuje ponovno procesiranje velikih količina podataka i ponovno podešavanje modela. Ovaj dugotrajan i zahtevan proces ne samo da povećava troškove razvoja, već i odlaže dobijanje pouzdanih i validnih rezultata, čime se smanjuje efikasnost istraživanja i eksperimentalnih testiranja.
...
Tokom 2021. godine, izveštaji su pokazali da su policijske uprave u brojnim američkim gradovima koristile \textbf{Clearview.AI} za identifikaciju pojedinaca, uključujući i učesnike protesta pokreta \textit{Black Lives Matter} \cite{lee2024deepfakesphrenologysurveillancemore}. Ovde se direktno ugrožava privatnost građana bez njihovog znanja i saglasnosti. 

Godine 2022, umetnica iz Kalifornije otkrila je da su fotografije za koje je verovala da se nalaze isključivo u njenim privatnim medicinskim zapisima, bez njenog znanja i pristanka, završile u skupu podataka za treniranje \textbf{LAION}-a — baze podataka korišćene za obučavanje modela kao što su \textit{Stable Diffusion} i \textit{Google Imagen}. Umetnica, koja ima retko medicinsko stanje koje je želela da zadrži privatnim, izrazila je zabrinutost zbog potencijalne zloupotrebe generativnih AI tehnologija koje imaju pristup njenim fotografijama \cite{lee2024deepfakesphrenologysurveillancemore}. Ovaj primer pokazuje da, i pored zakonskih i etičkih okvira u medicini, postoji rizik od neovlašćenog korišćenja osetljivih podataka pacijenata.

U januaru 2023. godine, \textit{Twitch} strimerka \textit{QTCinderella} uputila je javni apel pratiocima na mreži \textit{X} (bivšem \textit{Twitteru}) da prestanu sa širenjem linkova ka nelegalnom sajtu koji je hostovao AI-generisanu deepfake pornografiju nje i drugih poznatih žena sa interneta. \textit{„Biti viđen 'nag' protiv svoje volje ne bi trebalo da bude deo ovog posla“}, izjavila je \cite{lee2024deepfakesphrenologysurveillancemore}. Ovaj incident ilustruje kako generativni AI alati mogu biti zloupotrebljeni za širenje nelegalnog i štetnog sadržaja, direktno ugrožavajući privatnost, dostojanstvo i integritet pojedinaca.
...
Tu se postavljaju nova \textit{pravna i etička pitanja}:  
Ko preuzima kredibilitet za napisani naučni rad — da li \textit{autor veštačke inteligencije} ili \textit{osoba koja je rad generisala}?  
Da li se takav rad može prihvatiti kao \textit{intelektualna svojina pojedinca}?  
...
Međutim, ovo nije neuobičajeno za tehnologije koje se u velikoj meri oslanjaju na obradu podataka. Propisi poput Opšte uredbe o zaštiti podataka (GDPR) neizbežno zaostaju za tehnološkim razvojem, iz razloga što je izuzetno teško prilagođavati regulativu istim tempom kojim se razvija tehnologija \cite{mitrou_gdpr_ai_2018}.
...
\subsection{Strategije za zaštitu privatnosti u eri veštačke inteligencije}
...
Veštačka inteligencija predstavlja tehnologiju sa značajnim potencijalom i rizicima. Iako može biti korišćena za kreiranje lažnog sadržaja, manipulaciju informacijama, narušavanje privatnosti ili čak ugrožavanje reputacije pojedinaca, njena primena donosi i brojne koristi u poslovnim, edukativnim i zabavnim domenima. Pažljivo osmišljena upotreba AI alata može smanjiti rizike, dok istovremeno omogućava unapređenje produktivnosti, pristup informacijama i razvoj novih oblika kreativnosti.

Veštačka inteligencija sve brže postaje neizostavan deo naših života. Podaci postaju sve dostupniji, ali se time povećava i mogućnost manipulacija. Iako postoje brojna pitanja vezana za privatnost, promišljena i odgovorna upotreba AI tehnologija omogućava smanjenje rizika na minimum. AI alati stoga ne predstavljaju pretnju koju treba izbegavati, već resurs koji, ukoliko se koristi obazrivo i smisleno, može značajno doprineti razvoju društva i unapređenju svakodnevnog života.

Budući razvoj AI zahteva sveobuhvatno razmatranje pitanja privatnosti, bezbednosti i etike, kao i kontinuiranu edukaciju korisnika i stručnjaka. Samo kombinacija tehničkih, pravnih i edukativnih mera može omogućiti bezbedno i odgovorno korišćenje ovih tehnologija.

Razvoj veštačke inteligencije donosi i nove izazove. Automatizacija velikog broja poslova i sve veće oslanjanje na autonomne sisteme za obradu podataka otvaraju pitanja koja u ovom trenutku još uvek ne možemo u potpunosti predvideti, čime se ističe potreba za stalnim prilagođavanjem i unapređenjem regulatornih i etičkih okvira.
