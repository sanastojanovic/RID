...
\title{\textbf{Kako video igre utiču na malu decu}\\\large Seminarski rad}
\author{Danilo Nikolaš\\112/2021}
\date{Novembar 2025}
...
\begin{itemize}
    \item \textbf{edukativne igre} (logičke zagonetke, učenje jezika, matematike),
    \item \textbf{kreativne i sandbox igre} (npr. Minecraft) — razvoj mašte, planiranja i timskog rada,
    \item \textbf{akcione i refleksne igre} (trkačke, platformeri) — razvoj brzine reakcije i vizuelne percepcije,
    \item \textbf{mobilne „casual” igre} sa kratkim ciklusima nagrađivanja,
    \item \textbf{kooperativne online igre} — razvoj socijalne interakcije, ali uz rizik od socijalnog pritiska.
\end{itemize}
...
Vizuelno–prostorne veštine se takođe značajno razvijaju — igrači često pokazuju poboljšanu sposobnost mentalne rotacije objekata, orijentacije u prostoru i praćenja više vizuelnih elemenata istovremeno.
...
Ovi efekti su posebno izraženi kod igara koje uključuju zadatke poput preciznog ciljanje, upravljanja objektima ili veštine ritma i koordinacije.
...
Igre često koriste kratke cikluse uspeha, vizuelne i zvučne nagrade, otključavanje nivoa i sistem napredovanja (XP). Ovakvi mehanizmi aktiviraju dopaminske puteve u mozgu, što stvara osećaj prijatnosti i motiviše dete da se vraća igri \cite{pontes2020insights}.  
...
\begin{itemize}
    \item jasne vremenske granice korišćenja uređaja,
...
Razumevanje neurobioloških mehanizama koji stoje iza digitalnih navika pomaže roditeljima i obrazovnim institucijama da pravovremeno reaguju i podrže dete u razvijanju samokontrole i odgovornih digitalnih navika.
...
\bibitem{satghare2021igd}
P.~Satghare, A.~Abdin, S.~Shafie, S.~C. Chong, and M.~S.~H. Subramaniam,
``Epidemiology and Clinical Features of Internet Gaming Disorder: A Systematic Review,''
\textit{Frontiers in Psychiatry}, vol.~12, 2021.
Available at: \url{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7925601/}
