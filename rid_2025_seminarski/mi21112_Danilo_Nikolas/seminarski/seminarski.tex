...
roditeljskog nadzora i okruženja u kom dete odrasta. 
Cilj ovog rada je da pruži uravnotežen pogled zasnovan na dostupnoj literaturi, 
da objasni psihološke i neurološke procese uključene u igranje, te predstavi koristi, rizike i smernice za zdravu upotrebu video igara.
...
\begin{itemize}
    ...
    (npr. \textit{Minecraft}, \textit{The Sims}) - razvijaju maštu, planiranje, saradnju i sposobnost samostalnog stvaranja sadržaja.
    \item \textbf{Akcione i refleksne igre} 
    (npr. \textit{Crash Bandicoot}, \textit{Mario Kart}) - unapređuju brzinu reakcije, koordinaciju pokreta i vizuelnu percepciju.
    ...
    (npr. \textit{Minecraft Multiplayer}, \textit{Overcooked}) - omogućavaju zajedničku igru i komunikaciju sa vršnjacima, ali nose i rizik od pritiska grupe i neprimerenog online okruženja bez nadzora.
\end{itemize}
...
Deca koja povremeno igraju igre koje uključuju logiku, prostornu orijentaciju ili zadatke brzog odlučivanja mogu pokazati bolje rezultate u kognitivnim testovima, bržu obradu informacija i bolju sposobnost rasuđivanja. Odličan primer ovoga bi bila igrica \textbf{Portal}, u kojoj dete mora svaki svoj korak da planira unapred kako bi rešilo prostorne slagalice sa portalima.

Vizuelno–prostorne veštine se takođe značajno razvijaju — igrači razvijaju sposobnost da u glavi zamišljaju predmete iz različitih uglova i lakše se orijentišu u prostoru. U ovu katerogiju spadaa dobro poznata igrica \textbf{Minecraft}, gde dete zamišlja objekte u prostoru i poboljšava orijentaciju i sposobnost snalaženja u 3D okruženju.

\subsection*{Koordinacija i motoričke veštine}
Pravilno izabrane igre podstiču preciznost u pokretima i pozitivno utiču na razvoj motoričke sposobnosti.
Ovi efekti su posebno izraženi kod igara koje uključuju zadatke poput preciznog ciljanja, upravljanja objektima ili veštine ritma i koordinacije. Odličan primer ovakve igre može biti igra \textbf{Just Dance}, u kojoj deca treba da ponavljaju pokrete iz igrice u ritmu, dok senzor beleži njihove pokrete i ocenjuje tačnost pokreta.

\subsection*{Kreativnost i maštovito mišljenje}
Kreativne i „sandbox” igre, omogućavaju deci da grade, eksperimentišu i razvijaju originalne ideje u virtuelnom okruženju. 
Deca često prenose inspiraciju iz igara u realni svet, kroz crtanje, izradu maketa ili simboličku igru, što podržava razvoj imaginacije i divergentnog mišljenja. Lep primer ovakve igre je \textbf{Sims}, gde deca kreiraju svoje likove, kreiraju svoje kuće i cele životne priče.
...
Kooperativne igre mogu pomoći u razvoju veština saradnje, pregovaranja i zajedničkog rešavanja problema. Kod introvertne dece, ovakve interakcije ponekad olakšavaju socijalnu integraciju i izražavanje u grupi. Jedna takva igrica je \textbf{Overcooked}, u kojoj deca uz timski rad zajedno moraju da drže svoj restoran i u jako kratkom vremenskom periodu odrade što više porudžbina kako bi pobedili.
...
Neka istraživanja ukazuju da deca koja imaju pozitivno iskustvo sa rešavanjem zadataka u digitalnom okruženju pokazuju veći nivo motivacije za rešavanje problema i u realnom svetu. Takvih igara ima mnogo, ali ja bih izdvojio \textbf{Spyro} kao odlicnu dečiju igricu u kojoj mali zmaj savladava prepreke, istražuje svet i bori se sa protivnicima. Biće sigurno puno uspeha i neuspeha, ali daje priliku detetu da donekle nauči kako da se nosi sa frustracijom i raznim izazovima, jer će tako brže uspeti da savlada tešku prepreku.
...
Kada su pažljivo odabrane, ovakve igre mogu nadograditi učenje iz škole, razviti radoznalost i ponuditi bezbedno okruženje za eksperimentisanje i donošenje odluka. Jedna takva igra bi bila \textbf{Toca Life World} koja simulira situacije iz realnog sveta, kao što su odlazak u prodavnicu, priprema obroka, briga o likovima, odlazak u školu itd.
...
Ovaj efekat je naročito izražen kod dece sa već postojećim teškoćama u samokontroli. Takva igra je \textbf{Subway Surfers}, gde se sve odvija jako brzo, dinamično i zasnovano na stalnom skrolovanju i instant reakcijama. Iako razvija reflekse, mozak se navikava na kratke impulse i smanjuje toleranciju na sporije aktivnosti.
...
Ukorenjivanje ovakvih reakcija može otežati razvoj emocionalne stabilnosti i tolerancije na stres. Primer jedne ovakve igre je \textbf{Clash Royale} u kojoj se dva takmičara bore u areni postavljajući kartice sa likovima. Igrica je delom i strateška što razvija logiku, međutim izaziva velike frustracije jer dete ne može da utiče na sve faktore ishoda i može se desiti dosta gubitaka za redom.
...
Narušen san utiče na koncentraciju, raspoloženje i učenje. Igra \textbf{Hay Day} koja je naizgled jako lepa igra gde pravite svoju farmu, spada u tu kategoriju. Zahteva da jako često ulazite u igru u uzimate resurse, pa i tempirate ulazak kako bi stavili novu nadogradnju, jer se svaka od tih nadogradnji čeka po par sati ili čak i dana.
...
Svetska zdravstvena organizacija preporučuje ograničeno vreme pred ekranom i svakodnevnu fizičku aktivnost kao deo zdravog razvoja deteta \cite{who_guidelines_2020}. U ovu kategoriju spada skoro svaka igra ukoliko se ne vodi računa o vremenu igranja.
...
Pojedini sadržaji koji uključuju agresivno ponašanje mogu doprineti povećanoj razdražljivosti i smanjenoj empatiji kod osetljive dece, naročito bez nadzora i razgovora o sadržaju. I u ovu katerogiju takođe može spadati skoro svaka igra, pa je važno voditi računa o ovome.
