...
Razlika između interneta i veba je da internet čini mrežnu infrastrukturu i internet protokole dok je WWW usluga definisana i koristi HTTP protokol i zavisi od interenta. Evolucija veba. Centralizacija usluga veba. Dinamički i statički sajtovi.
...
\subsection{Predložene teme}
\begin{itemize}
    \item Packet sniffers and their usage
    \begin{itemize}
...
\begin{itemize}
    ...
    \item Autocenzura
\end{itemize}
U kojim oblastima najviše dolazi do autocenzure na društvenim mrežavam i zašto su to svakodnevni život i lično mišljenje i na koji način internet sprečava cenzuru. Mnogi autoritarni režimi imaju monopol nad internetom gde se vrši cenzura interneta. Kako se boriti protiv cenzure? Iako je nemogućnost potpune cenzure interneta u svojoj osnovi dobra stvar, kako manjak cenzure utiče na decu koja koriste internet mlađa nego ranije? Deca su izložena, čak i uz najobičnniju pretragu, eksplicitnom sadržaju, samopovređivanju, pornografiji. 
Koji su tipovi neprikladnog sadržaja i kako zaštititi dete. Primer zaštite deteta od necenzurisanog intereneta su internet filteri ili roditeljski nadzor, kao i otvorena i iskrena komunikacija sa decom i zajedničko istraživanje interneta.
\subsection{Predložene teme}
\begin{itemize}
...
\end{itemize}
Koliku kontrolu ima država nad svakodnevnim stanovništvom putem električnog nadzora, kako možemo uticati na zaštitu privatnosti? 
Neki od primera zaštitne privatnosti su enkripcija i VPN.
\subsection{Predložene teme}
\begin{itemize}
    \item Da li nas VPN stvarno štiti i koje informacije prikuplja o nama?
    \begin{itemize}
