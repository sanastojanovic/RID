...
\subsection{Pregled gradiva}
Privatnost je izraz kojim se označava pravni, odnosno društveni koncecpt prema kome svaki pojedinac može određene aktivnosti, mišljenje ili osećaje zadržati za sebe, odnosno ne dopustiti da za njih znaju drugi pojedinci, organizacije, delovi društva ili javnost. Definisanje šta tačno čini, a šta ne čini privatnost drastično se razlikuje od kulture do kulture. Problem u definisanju privatnosti leži u širini i neodređenosti ovog pojma. Upravo jedna od vrsta privatnosti jeste privatnost na internetu. Ključni pojam u raspravama o tome šta je privatnost je koncept pristupa. Najčešće korisnici ostavljaju svesno i voljno informacije o sebi na interentu, međutim svest o prikupljanju informacija o korisnicima protiv njihove volje je veoma mala. Korisnici sve više brišu informacije o sebi i veća je upotreba privatnih naloga nego pre. 
...
Informacije koje kolačići čuvaju o nama:
\begin{itemize}
...
\end{itemize}
Načini na koje se možemo zaštititi od kolačića:
\begin{itemize}
...
\end{itemize}
Kontrola države nad svakodnevnim stanovništvom putem digitalnog nadzora je sve veća i veća.
Neki od primera zaštite privatnosti prilikom korišćenja interneta su enkripcija i VPN.
\subsection{Predložene teme}
\begin{itemize}
