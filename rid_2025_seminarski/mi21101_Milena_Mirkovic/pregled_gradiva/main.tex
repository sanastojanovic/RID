...
\HRule \\[0.4cm]
{ \huge \bfseries Pregled gradiva}\\[0.4cm] 
\HRule \\[1.5cm]
...
\begin{enumerate}
    \item Doprinos žena razvoju računarsva i postavljanju temelja programiranja u XX veku
        \begin{description}
            \item Ada Lovelace kao prva programerka.  
            \item \url{https://www.youtube.com/watch?v=IZptxisyVqQ}
            \item Žene programeri kompanije ENIAC. \item \url{https://www.youtube.com/watch?v=Zevt2blQyVs}
        \end{description}
    \item Računari u Jugoslaviji: zaboravljena istorija CER i TARA računara
        \begin{description}
            \item \url{https://www.youtube.com/watch?v=T8iebSL49NM}
            \item \url{https://www.rts.rs/lat/magazin/tehnologija/5583359/dan-informaticara-srbije-prvi-racunar-cer10-18-novembar-1960.html}
        \end{description}
    \item Društveni uticaj računara: od prvog popisa do digitalnog doba
        \begin{description}
            \item \url{https://www.youtube.com/watch?v=WWzaZWN1IOU}
        \end{description}
\end{enumerate}
...
\begin{enumerate}
    \item Nadzor i prepoznavanje lica: privatnost, ljudska prava i društvene posledice
        \begin{description}
            \item \url{https://www.youtube.com/watch?v=2SdpzTZTznw}
            \item \url{https://www.youtube.com/watch?v=CK-mkq0HQ2w}
        \end{description}
    \item Etika lažnih vesti i dezinformacija na internetu
        \begin{description}
            \item \url{https://journals.publishing.umich.edu/jpe/article/id/6195/}
            \item \url{https://www.youtube.com/watch?v=uCESQTkxuN0}
        \end{description}
    \item AI-generisana umetnost i kreativnost
        \begin{description}
            \item \url{https://link.springer.com/article/10.1007/s43681-025-00735-3}
            \item \url{https://ai-arts.org/}
            \item \url{https://aifcf.org/}
        \end{description}
\end{enumerate}

\section{Upotreba interneta, spam poruke}
\subsection{Pregled gradiva}
U današnjem svetu sve više ljudi ima mobilni telefon i pristup internetu. Internet mreže omogućavaju bržu komunikaciju i brže obavljanje svakodnevnih poslova. Ipak, uz sve prednosti, moderna komunikacija donosi i niz etičkih izazova i zloupotreba.
...
\begin{enumerate}
    \item Spam i ekološki uticaj digitalnog otpada
        \begin{description}
            \item \url{https://www.theguardian.com/environment/green-living-blog/2010/oct/21/carbon-footprint-email} 
            \item \url{https://blog.cabi.org/2011/08/05/ever-wondered-what-the-carbon-footprint-of-your-spam-emails-is/}
        \end{description}
    \item Etika automatizacije i botova u slanju poruka
        \begin{description}
            \item \url{https://www.forbes.com/councils/forbescoachescouncil/2024/11/06/ethical-ai-in-marketing-balancing-automation-with-human-values/}
            \item \url{https://mint.rs/blog/bezbednost/zasto-e-mail-poruke-zavrsavaju-u-spam-folderu/}
        \end{description}
\end{enumerate}
...
\begin{enumerate}
  \item Monopol nad informacijama od strane vlade ili države,
  \item Pregled publikacije,
  \item Licenciranje i registracija.
\end{enumerate}


Internet se često koristi za širenje dezinformacija i manipulacija. Kao odgovor, vlasti i platforme mogu primeniti vidove cenzure, ne uvek u potpunoj zabrani, već u smanjenoj vidljivosti određenog sadržaja. Postoje situacije kada je regulacija opravdana, kao u slučaju zaštite dece od neprikladnog sadržaja. Međutim, granica između zaštite i preterane kontrole je često tanka i zahteva pažljivu etičku procenu.
...
\begin{enumerate}
    \item Digitalni trag i privatnost korisnika
        \begin{description}
            \item \url{https://www.youtube.com/watch?v=cprsK9uoYjk&t=2s}
            \item \url{https://www.internetsociety.org/blog/2024/10/understanding-digital-footprints/}
        \end{description}
    \item Cyberbullying i digitalna odgovornost
        \begin{description}
            \item \url{https://cyberpsychology.eu/article/view/35784}
            \item \url{https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2022.861823/full}
        \end{description}
\end{enumerate}
...
Među najvećim problemima interneta ubraja se i zavisnost od interneta. U nekim zemljama se ova zavisnost posmatra kao psihička bolest. Ova zavisnost izaziva probleme poput depresije, anksioznosti, promene raspoloženja, usamljenosti, glavobolje, insomnije i slično.
...
\begin{enumerate}
    \item Psihologija phishing-a: zašto ljudi klikću i kad znaju da ne bi smeli
        \begin{description}
            \item \url{https://www.sciencedirect.com/science/article/pii/S0167404823005813}
            \item \url{https://www.youtube.com/watch?v=AQLxyjuDTwQ}
        \end{description}
    \item Digitalna detoksikacija: lečenje zavisnosti od interneta
        \begin{description}
            \item \url{https://www.youtube.com/watch?v=SKNjQtkeJWg}
            \item \url{https://www.verywellmind.com/internet-addiction-4157289}
        \end{description}
    \item Digitalna hiperpažnja: deca i vizuelni stimulansi 
        \begin{description}
            \item \url{https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2020.00961/full}
            \item \url{https://www.sciencedirect.com/science/article/pii/S0360131521001332}
            \item \url{https://www.youtube.com/watch?v=3h1T493piLE}
        \end{description}
\end{enumerate}
...
\subsection{Pregled gradiva}
Značenje reči haker se menjalo vremenom. U prošlom veku haker je označavao istraživača, osobu koja preuzima rizik, nekoga ko čini da sistem radi nešto novo. Danas se termin haker vezuje za osobu koja neovlašćeno pristupa računarima i računarskim mrežama.
...
\begin{itemize}
    ...
    \item Računarski crvi
        \begin{itemize}
            \item Internet crvi - samostalni program koji se širi preko računarske mreže. Crv se širi sam od sebe iskorišćavanjem bezbednosnih rupa na udaljenim računarima.
...
\begin{enumerate}
    \item Evolucija zlonamerkog softvera 
        \begin{description}
            ...
            \item \url{https://www.forbes.com/councils/forbestechcouncil/2024/03/19/how-ai-driven-cyber-attacks-will-reshape-cyber-protection/}
        \end{description}
    \item „Pametni dom“ kao meta hakera
        \begin{description}
            \item \url{https://www.quectel.com/} 
            \item \url{https://www.cisco.com/site/us/en/products/security/industrial-security/index.html}
        \end{description}
\end{enumerate}
...
Kolačići su male tekstualne datoteke koje sajtovi koriste za pamćenje informacija poput prijava, sadržaja korpe i slično. Postoje sesijski (kratkotrajni) i trajni kolačići, koji imaju rok trajanja i čuvaju se na računaru. Trajni kolačići se dele na kolačiće prve strane, koji se prate samo od strane veb sajtova koji su ih napravili, i na kolačiće treće strane koji prate korisnika na drugim domenima.
Zahvaljujući zakonima, sajtovi moraju da traže direktnu saglasnost za upotrebu kolačića, što korisnici često ne razumeju jer ne čitaju pravila privatnosti.
...
\begin{itemize}
  \item Big Data i etika privatnosti
    \begin{description}
        \item \url{https://hbr.org/2023/07/the-ethics-of-managing-peoples-data} 
        \item \url{https://www.youtube.com/watch?v=bAyrObl7TYE}
    \end{description}
\end{itemize}
